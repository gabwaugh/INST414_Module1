...
# Convert 'Rating' column to numeric values and handle missing values
df_cardio['Rating'] = pd.to_numeric(df_cardio['Rating'], errors='coerce')

# Drop rows with missing values in 'Rating' column and 'Title'n column
...
# Plot the average ratings for each cardio workout
